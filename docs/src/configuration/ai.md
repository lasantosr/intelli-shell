...
```toml
{{#include ../../../default_config.toml:254:256}}
```
...
```toml
{{#include ../../../default_config.toml:259:270}}
```
...
```toml
{{#include ../../../default_config.toml:281:287}}
```
...
You can view the well-tuned default prompts in the [`default_config.toml`](https://github.com/lasantosr/intelli-shell/blob/main/default_config.toml#L285)
